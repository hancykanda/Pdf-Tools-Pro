...
export default function PDFtoExcelPage() {
  ...
  return (
    <ToolPageShell title="PDF to Excel" description="Extract tables and data from PDFs to Excel spreadsheets." icon={FileText}>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          {!file ? (
            <ToolUploadZone
              ...
              subtitle="Tables and data will be extracted to Excel"
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between h-fit">
          <div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed mb-6 font-sans">
              Extract tables and text from your PDF into an Excel spreadsheet. Complex layouts may need manual adjustment.
            </p>
          </div>
