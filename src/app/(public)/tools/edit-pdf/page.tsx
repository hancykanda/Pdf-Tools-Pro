...
import { Type, Upload, Download, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function EditPdfPage() {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/tools/edit-pdf', {
        ...
        body: JSON.stringify({ file: base64, overlayText, xPosition, yPosition, fontSize }),
      });
  ...
  return (
    <ToolPageShell title="Edit PDF" description="Add text, images, and shapes to PDF documents." icon={Type}>
        ...
        {step === 'options' && (
          <div className="space-y-6">
            <ToolCard>
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Configure the overlay for your PDF
                  </p>
                </div>
                <button
            ...
            <div className="flex justify-end gap-3">
              ...
              <ToolPrimaryButton onClick={handleEdit} loading={isProcessing}>
                {isProcessing ? (
                  <>
