...
export default function AISummarizerPage() {
  ...
  return (
    <ToolPageShell title="AI Summarizer" description="Generate concise summaries of PDF content using AI." icon={FileText}>
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between h-fit">
          <div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed mb-6 font-sans">
              Generate concise summaries of PDF content using AI.
            </p>
          </div>
