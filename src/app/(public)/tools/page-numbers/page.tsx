...
import { Hash, Upload, Download, CheckCircle2, AlertCircle, Info } from 'lucide-react';
          ...
          <div className="space-y-6">
            <ToolCard>
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="font-display font-bold text-xl text-brand-dark mb-1">Page Number Settings</h2>
                  <p className="text-sm text-gray-500">Configure options and start processing</p>
                </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl">
                <div className="p-3 bg-white border border-gray-100 rounded-xl text-brand-red"><Hash className="w-6 h-6" /></div>
            ...
            <div className="flex justify-end gap-3">
              ...
              <ToolPrimaryButton onClick={handleProcess} loading={isProcessing}>
                {isProcessing ? (<><div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin shrink-0" /><span>Processing...</span></>) : (<><Hash className="w-5 h-5 shrink-0" /><span>Add Page Numbers</span></>)}
              </ToolPrimaryButton>
            </div>
          </div>
        )}
        ...
        {step === 'download' && (
          <div className="space-y-6">
            <ToolCard className="text-center py-12 sm:py-16">
              ...
              <h2 className="font-display font-bold text-2xl sm:text-3xl text-brand-dark mb-3">Page Numbers Added Successfully!</h2>
